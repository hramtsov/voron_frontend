...
export default function (ctx, inject) {
  ...
  // Register strategies
  // local
  $auth.registerStrategy('local', new scheme_003d9a64($auth, {"endpoints":{"login":{"url":"/auth/login","method":"post","propertyName":"data.token"},"logout":{"url":"/auth/logout","method":"post"},"user":{"url":"/user/info","method":"get","propertyName":"data"}},"_name":"local"}))
