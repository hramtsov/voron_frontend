            ...
            >
               <div :class="cellClasses(column)">
                  ...
                  <template v-else>
                     ...
                     <Poptip v-if="column.help" :transfer="true" trigger="hover" placement="bottom">
                        <i class="fad fa-info-circle help-icon"></i>
                        <div slot="title">
                           <b>{{ column.title }}</b>
                        </div>
                        <div slot="content">{{ column.help }}</div>
                     </Poptip>
...
<script>
import CheckboxGroup from "view-design/src/components/checkbox/checkbox-group.vue"; // '../checkbox/checkbox-group.vue';
import Checkbox from "view-design/src/components/checkbox/checkbox.vue"; // "../checkbox/checkbox.vue";
import Poptip from "view-design/src/components/poptip/poptip.vue"; // "../poptip/poptip.vue";
import iButton from "view-design/src/components/button/button.vue"; // "../button/button.vue";
