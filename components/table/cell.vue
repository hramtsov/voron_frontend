...
import Icon from "view-design/src/components/icon/icon.vue"; // '../icon/icon.vue';
import Checkbox from "view-design/src/components/checkbox/checkbox.vue"; // "../checkbox/checkbox.vue";
import Tooltip from "view-design/src/components/tooltip/tooltip.vue"; // "../tooltip/tooltip.vue";
