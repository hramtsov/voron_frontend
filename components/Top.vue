   ...
   <div class="navbar-inner">
      ...
      <div class="navbar-item">
         <!-- <div class="top-menu-item">
            <a @click="$store.dispatch('sidebar/toggleCollapse')">Открыть</a>
         </div>-->
         ...
         <div class="top-menu-item account-fullname">
            <Avatar
               ...
               size="small"
            >{{$auth.user.profile.firstname[0]}}{{$auth.user.profile.lastname[0]}}</Avatar>
         ...
         <Dropdown
            ...
            :transfer="false"
            v-on:on-click="profileMenu($event)"
         >
            <a>
               ...
               <DropdownItem>
                  <div class="dropdown-into">
                     ...
                     <div class="dropdown-info">
                        ...
                        <div
                           class="dropdown-text"
                        >Разнообразный и богатый опыт начало повседневной работы по формированию позиции в значительной степени обуславливает создание новых предложений.</div>
                     </div>
                  </div>
               </DropdownItem>
               <DropdownItem>
